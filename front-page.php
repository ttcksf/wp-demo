<?php get_header();?>
    ...
    <!-- CPTUI→タクソノミーの追加と編集 -->
    <!-- カスタム投稿版のカテゴリーとタグになる -->
    <!-- スラッグ（category,tagは使用済みのため文言を変える）を英語、ラベル２箇所（管理画面での表示名）を同じ日本語にして、作成済みのカスタム投稿タイプのラベルをチェック -->
    <!-- 「カスタム投稿カテゴリー」「カスタム投稿タグ」に分ける -->
    <!-- 編集するには「たくそのみーの編集」タブ→選択からラベルを選択する -->
    <!-- UI表示をTrueにしないと管理画面に表示されない -->
